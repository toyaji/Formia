...
import { Undo2, Redo2, Save, Play, Settings, Cloud, FileCode, Check, RefreshCw, AlertCircle, Info, Send } from 'lucide-react';
...
export const Header = () => {
  const { 
    formFactor, history, future, undo, redo, applyJsonPatch,
