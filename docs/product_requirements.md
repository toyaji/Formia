# Product Requirements: Formia

## 1. Overview

Formia is an AI-first form builder that prioritizes speed of creation and high-quality UX through an agentic interface.
...
- **HR Managers**: Need quick internal surveys.
- **Developers**: Need a customizable, API-first form solution.

## 4. Success Metrics

- **Time-to-Publish**: Reducing the time to create a complex form from 30 minutes to 5 minutes.
- **User Engagement**: High interaction rate with the AI agent.
